...
public:
    ...
    bool FindNext(const QString &search_regex,
        ...
        return BookViewPreview::FindNext(search_regex, search_direction, check_spelling, ignore_selection_offset, wrap, selected_text, exclude_html_tag);
    }
    ...
    int Count(const QString &search_regex, Searchable::Direction direction, bool wrap, bool selected_text = false, bool exclude_html_tag = false) {
        return BookViewPreview::Count(search_regex, direction, wrap, selected_text, exclude_html_tag);
    }
    ...
    bool ReplaceSelected(const QString &search_regex, const QString &replacement, Searchable::Direction direction = Searchable::Direction_Down, bool keep_selection = false, bool exclude_html_tag = false) {
        return BookViewPreview::ReplaceSelected(search_regex, replacement, direction, keep_selection, exclude_html_tag);
    }
    ...
    int ReplaceAll(const QString &search_regex, const QString &replacement, Searchable::Direction direction, bool wrap, bool selected_text, bool exclude_html_tag) {
        return BookViewPreview::ReplaceAll(search_regex, replacement, direction, wrap, selected_text, exclude_html_tag);
    }
     ...
     */
    void FormatBlock(const QString &element_name, bool preserve_attributes, const QString &class_id = QString());
