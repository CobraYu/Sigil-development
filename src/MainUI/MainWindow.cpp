...
void MainWindow::SetStateActionsBookView()
{
	...
	ui.actionHeadingNormal_Plus->setEnabled(true);
	ui.actionHeadingSpan_Plus->setEnabled(true);
	ui.actionHeadingDiv_Plus->setEnabled(true);
...
void MainWindow::SelectEntryOnHeadingToolbar(const QString &element_name)
{
	...
	ui.actionHeadingNormal_Plus->setChecked(false);
	ui.actionHeadingSpan_Plus->setChecked(false);
	ui.actionHeadingDiv_Plus->setChecked(false);
    ...
    if (!element_name.isEmpty()) {
        if ((element_name[ 0 ].toLower() == QChar('h')) && (element_name[ 1 ].isDigit())) {
			...
			ui.actionHeadingNormal_Plus->setChecked(true);
			ui.actionHeadingSpan_Plus->setChecked(true);
			ui.actionHeadingDiv_Plus->setChecked(true);
        }
    }
}
...
void MainWindow::ExtendUI()
{
	...
	sm->registerAction(this, ui.actionHeadingNormal_Plus, "MainWindow.HeadingNormal_Plus");
	sm->registerAction(this, ui.actionHeadingSpan_Plus, "MainWindow.HeadingSpan_Plus");
	sm->registerAction(this, ui.actionHeadingDiv_Plus, "MainWindow.HeadingDiv_Plus");
...
void MainWindow::ExtendIconSizes()
{
	...
	icon = ui.actionHeadingNormal_Plus->icon();
	icon.addFile(QString::fromUtf8(":/main/heading-normal_16px_plus.png"));
	icon.addFile(QString::fromUtf8(":/main/heading-normal_22px_plus.png"));
	ui.actionHeadingNormal_Plus->setIcon(icon);
	icon = ui.actionHeadingSpan_Plus->icon();
	icon.addFile(QString::fromUtf8(":/main/heading-span_16px_plus.png"));
	icon.addFile(QString::fromUtf8(":/main/heading-span_22px_plus.png"));
	ui.actionHeadingSpan_Plus->setIcon(icon);
	icon = ui.actionHeadingDiv_Plus->icon();
	icon.addFile(QString::fromUtf8(":/main/heading-div_16px_plus.png"));
	icon.addFile(QString::fromUtf8(":/main/heading-div_22px_plus.png"));
	ui.actionHeadingDiv_Plus->setIcon(icon);
...
void MainWindow::ConnectSignalsToSlots()
{
	...
	connect(ui.actionHeadingNormal_Plus, SIGNAL(triggered()), m_headingMapper, SLOT(map()));
...
void MainWindow::updatePalette()
{
	...
	cd.exec();
	//QColor color = QColorDialog::getColor(Qt::red, this, tr("Color Editor"), QColorDialog::NoButtons | QColorDialog::DontUseNativeDialog);
	//QColor color = QColorDialog::getColor(Qt::red, this, tr("Color Editor"), QColorDialog::NoButtons | QColorDialog::DontUseNativeDialog);
	//if (!color.isValid())
		//return;
	//connect(tab, SIGNAL(ClearMarkedTextRequest()), this, SLOT(ClearMarkedText()));
